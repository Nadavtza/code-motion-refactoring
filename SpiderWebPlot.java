...
public class SpiderWebPlot extends Plot implements Cloneable, Serializable {
	...
	public Paint getSeriesPaint(int series) {
		seriesPaintListModifier(series);
		return computeResult(series);
	}

	private void seriesPaintListModifier(int series) {
		if ((this.seriesPaintList.getPaint(series)  == null) && (this.seriesPaint == null))  {
	...
	private Paint computeResult(int series) {
