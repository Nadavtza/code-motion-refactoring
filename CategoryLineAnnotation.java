...
public void draw(Graphics2D g2, CategoryPlot plot, Rectangle2D dataArea,
	...
	double lineX1 = computeLineX1(dataArea, domainAxis, rangeAxis, catIndex1, catCount, orientation, domainEdge,
			rangeEdge);
	double lineY1 = computeLineY1(dataArea, domainAxis, rangeAxis, catIndex1, catCount, orientation, domainEdge,
			rangeEdge);
	double lineX2 = computeLineX2(dataArea, domainAxis, rangeAxis, catIndex2, catCount, orientation, domainEdge,
			rangeEdge);
	double lineY2 = computeLineY2(dataArea, domainAxis, rangeAxis, catIndex2, catCount, orientation, domainEdge,
			rangeEdge);
...
private double computeLineX1(Rectangle2D dataArea, CategoryAxis domainAxis, ValueAxis rangeAxis, int catIndex1,
	int catCount, PlotOrientation orientation, RectangleEdge domainEdge, RectangleEdge rangeEdge) {
	double lineX1 = 0.0f;
	if (orientation == PlotOrientation.HORIZONTAL) {
		...
		lineX1 = domainAxis.getCategoryJava2DCoordinate(
				CategoryAnchor.MIDDLE, catIndex1, catCount, dataArea,domainEdge);    
	 }
	return lineX1;
}
private double computeLineY1(Rectangle2D dataArea, CategoryAxis domainAxis, ValueAxis rangeAxis, int catIndex1,
	int catCount, PlotOrientation orientation, RectangleEdge domainEdge, RectangleEdge rangeEdge) {
	double lineY1 = 0.0f;
	if (orientation == PlotOrientation.HORIZONTAL) {
...
private double computeLineX2(Rectangle2D dataArea, CategoryAxis domainAxis, ValueAxis rangeAxis, int catIndex2,
	int catCount, PlotOrientation orientation, RectangleEdge domainEdge, RectangleEdge rangeEdge) {
	double lineX2 = 0.0f;
	if (orientation == PlotOrientation.HORIZONTAL) {
		...
		lineX2 = domainAxis.getCategoryJava2DCoordinate(
				   CategoryAnchor.MIDDLE, catIndex2, catCount, dataArea, domainEdge);		  
	}
	return lineX2;
}
private double computeLineY2(Rectangle2D dataArea, CategoryAxis domainAxis, ValueAxis rangeAxis, int catIndex2,
	int catCount, PlotOrientation orientation, RectangleEdge domainEdge, RectangleEdge rangeEdge) {
	double lineY2 = 0.0f;
	if (orientation == PlotOrientation.HORIZONTAL) {
